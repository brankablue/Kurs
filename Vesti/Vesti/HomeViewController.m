...
- (void)showConnectionError {
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Netwoek Error"message:@"Please provide Internet connection" preferredStyle:UIAlertControllerStyleAlert];
